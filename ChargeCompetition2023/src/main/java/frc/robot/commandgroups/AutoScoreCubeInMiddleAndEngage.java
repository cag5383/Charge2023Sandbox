...
public class AutoScoreCubeInMiddleAndEngage extends SequentialCommandGroup {
  /** Creates a new AutoScoreCubeInMiddleAndEngage. */
  public AutoScoreCubeInMiddleAndEngage(Drivetrain drivetrain, Arm arm, Claw claw) {
