...
public class Parralelautoscorecubeandengage extends SequentialCommandGroup {
  /** Creates a new AutoScoreCubeInMiddleAndEngage. */
  public Parralelautoscorecubeandengage(Drivetrain drivetrain, Arm arm, Claw claw) {
    ...
    //addCommands(new ClawEject(claw) new ChangeArmAngle(arm, 0));
