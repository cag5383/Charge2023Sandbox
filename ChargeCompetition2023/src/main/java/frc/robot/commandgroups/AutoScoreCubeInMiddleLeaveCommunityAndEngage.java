...
public class AutoScoreCubeInMiddleLeaveCommunityAndEngage extends SequentialCommandGroup {
  /** Creates a new AutoScoreCubeInMiddleAndEngage. */
  public AutoScoreCubeInMiddleLeaveCommunityAndEngage(Drivetrain drivetrain, Arm arm, Claw claw) {
