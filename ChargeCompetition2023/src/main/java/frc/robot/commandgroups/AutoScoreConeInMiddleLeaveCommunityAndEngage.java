...
public class AutoScoreConeInMiddleLeaveCommunityAndEngage extends SequentialCommandGroup {
  /** Creates a new AutoScoreCubeInMiddleAndEngage. */
  public AutoScoreConeInMiddleLeaveCommunityAndEngage(Drivetrain drivetrain, Arm arm, Claw claw) {
