...
public class VisionAlignDistanceAndAngle extends CommandBase {
  ...
  private double kDistanceSetpoint;
  private double kAngleSetpoint;

  public VisionAlignDistanceAndAngle(Vision vision, Drivetrain drivetrain, 
  double distanceSetpoint, double angleSetpoint) {
    ...
    kDistanceSetpoint = distanceSetpoint;
    kAngleSetpoint = angleSetpoint;
  }
  ...
  public void execute() {
    ...
    m_distanceOutput = m_distancePID.calculate(m_vision.getYOffset(), kDistanceSetpoint);
    m_angleOutput = m_anglePID.calculate(m_vision.getXOffset(), kAngleSetpoint);
